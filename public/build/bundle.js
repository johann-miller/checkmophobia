...
var app = (function () {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	if (exclude) {
    		$$subscribe_list(list = excluded);
    	} else {
    		$$subscribe_list(list = confirmed);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("title" in $$props) $$invalidate(0, title = $$props.title);
    		if ("exclude" in $$props) $$invalidate(1, exclude = $$props.exclude);
    		if ("list" in $$props) $$subscribe_list($$invalidate(2, list = $$props.list));
    		if ("active" in $$props) active = $$props.active;
    		if ("selected" in $$props) $$invalidate(3, selected = $$props.selected);
    		if ("disabled" in $$props) $$invalidate(4, disabled = $$props.disabled);
    		if ("oppositeSelected" in $$props) oppositeSelected = $$props.oppositeSelected;
    		if ("listFull" in $$props) listFull = $$props.listFull;
    	};
    	...
    	return [title, exclude, list, selected, disabled, toggle, click_handler];
    }

    class ChecklistItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { title: 0, exclude: 1 });
